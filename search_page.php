...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($check_cart_numbers) > 0){
      $message[] = 'deja dans le panier!';
   }else{
      mysqli_query($conn, "INSERT INTO `cart`(user_id, name, price, quantity, image) VALUES('$user_id', '$product_name', '$product_price', '$product_quantity', '$product_image')") or die('query failed');
      $message[] = 'inclu dans le panier!';
   }
...
<section class="search-form">
   <form action="" method="post">
      <input type="text" name="search" placeholder="produits..." class="box">
...
<section class="products" style="padding-top: 0;">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="price"><?php echo $fetch_product['price']; ?>FCFA</div>
   ...
   <?php
         ...
         echo '<p class="empty">aucune recherche!</p>';
      }
   ?>
   </div>
